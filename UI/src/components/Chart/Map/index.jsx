...
// console.log("distance",distance)
    ...
    buildGraph(data) {
        ...
        if (this.buildChart.get('chennai')) {
            this.buildChart.addSeries(
                {
                    ...
                    "data": [{
                        ...
                        color:"black",
                        "path": this.pointsToPath(this.buildChart.get('chennai'), this.buildChart.get('mumbai'))
                    },
                    {
                        // "id": "LocationB -> LocationA",
                        "path": this.pointsToPath(this.buildChart.get('chennai'), this.buildChart.get('bangalore'))
                    },
                    {
                        // "id": "LocationB -> LocationA",
                        "path": this.pointsToPath(this.buildChart.get('chennai'), this.buildChart.get('delhi'))
                    }
                ]
                }
            );
