...
export default class BrandCloud extends Component {
    ...
    componentDidMount() {
        if (this.WordCloudSVG !== undefined) {
            ...
            this.buildGraph(this.props.terms, this.props.animation, this.enableWordClick);
        }
    }
    componentWillReceiveProps(nextProps) {
        if (this.WordCloudSVG !== undefined) {
            ...
            this.buildGraph(nextProps.terms, nextProps.animation, this.enableWordClick);
        }
    }
    buildGraph(terms, animation, enableWordClick) {
        let classThis = this
        // Highcharts.seriesTypes.wordcloud.prototype.deriveFontSize = function (relativeWeight) {
        //     var maxFontSize = _.maxBy(terms.data,"weight").weight
        //    // Will return a fontSize between 0px and 25px.
        //    console.log(Math.floor(maxFontSize * relativeWeight),relativeWeight)
        //    return maxFontSize * relativeWeight;
        //  };
