...
import { Widget, toggleWidget, addResponseMessage, addLinkSnippet, Launcher } from "react-chat-widget";
...
class Chatbot extends Component {
  ...
  link = {
    title: "Hi! I'm JARVIS, the associate's chat bot. How can I assist you with your People metrics today? It is the responsibility of the authorised user to safeguard the information contained in this application. In the event you are using a public computer, please be aware of your immediate surroundings.  Click below to know about Walmart Privacy Policy.",
...
afterOpenModal() {
    ...
    this.subtitle.style.color = '#004793';
}
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <h4 className="modal-title">AI Assist</h4>
                <button type="button" onClick={this.openModal} className="close" data-dismiss="modal">
        ...
        <div className='feedback'>
                ...
                >
                    ...
                    <h2 ref={subtitle => this.subtitle = subtitle}>Hey, How did I do?</h2>
                        ...
                        <button className={"good"} onClick={this.good}>
                            <i className='far fa-laugh-beam'></i>
                        </button>
                        <button className="bad" onClick={this.bad}>
                            <i className='far fa-tired'></i>
                        </button>
                    
                    <button onClick={this.closeModal} className="close" data-dismiss="modal">close</button>
                </Modal>
            </div>
      </div>
    );
